<template>
  <q-page class="">
    ...
    <div>Deva Priyo's Lost at Last/One at Last - Priyo is featured on Sunheart's Nice, Unicorn Song and Wanderers Three</div>
    <div>Deva Priyo Nicola Notaro's Gypsy Moon and solo work</div>
  </q-page>
</template>
